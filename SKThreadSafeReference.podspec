#
#  Be sure to run `pod spec lint SKAsyncGLViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Stephen Kopylov" => "stephen@expertoption.com" }
  # Or just: s.author    = "Stephen Kopylov"
  # s.authors            = { "Stephen Kopylov" => "stephen@expertoption.com" }
  # s.social_media_url   = "http://twitter.com/Stephen Kopylov"
